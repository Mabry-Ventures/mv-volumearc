...
- `VolumeArcAppUITests` — XCUITest journey coverage, **sharded** into four partitions that run sequentially with per-shard simulator warm-up and retry budget (VOL-231)
