...
| `scripts/check_coach_eval_trend.sh` | Release-ready gate for response-layer coach quality: docs/marketing trend mirror, no stale record, and 47/47 passing fixtures with no axis failures |
