...
| Watch app | Implemented | HealthKit `HKWorkoutSession` + `HKLiveWorkoutBuilder`, WorkoutKit prescription export to Apple's Workouts app, rest timer, decisions, accessibility, offline payload queue, real phone/watch sync via WCSession |
